...
function WaitlistForm({ size = "inline" }: { size?: "hero" | "inline" }) {
  ...
  if (step === "qualify") {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md bg-white/92 backdrop-blur-2xl border border-white/70 rounded-3xl shadow-2xl p-8 overflow-hidden max-h-[90vh] overflow-y-auto">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white/95 backdrop-blur-2xl border border-white/60 rounded-3xl shadow-2xl p-8 text-center overflow-hidden">
    ...
    <header className="fixed top-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-lg border-b border-slate-100/80">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#waitlist" className="text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 px-5 py-2.5 rounded-xl transition-all shadow-md shadow-blue-600/20">
            Accès anticipé →
          </a>
        </div>
      </div>
        ...
        <section className="px-6 py-20 max-w-6xl mx-auto">
          <div className="relative bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-12 overflow-hidden text-center shadow-2xl shadow-blue-600/30">
            ...
            <div className="relative">
              ...
              <a href="#waitlist" className="inline-block bg-white text-blue-600 font-bold rounded-xl px-8 py-4 text-base hover:bg-blue-50 transition-all shadow-lg">
      ...
      <footer className="border-t border-slate-100 px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <div className="w-6 h-6 rounded-lg bg-blue-600 flex items-center justify-center"><svg className="w-3.5 h-3.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg></div>
